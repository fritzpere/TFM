    ...
    for i_band in range(-1,3):
        ...
        for i_state in range(3):
            ...
            for k in range(trials):
                ...
                feat_vect[band_dic[i_band]]['dim1'][k]=np.concatenate((np.array([avg_life[1][i_band][i_state][k],std_life[1][i_band][i_state][k],avg_midlife[1][i_band][i_state][k],std_midlife[1][i_band][i_state][k],entropy[1][i_band][i_state][k]]),pooling[0][i_band][i_state][k][:3]),axis=0)
                ...
                feat_vect[band_dic[i_band]]['dim0pooling'][k]=pooling[0][i_band][i_state][k][:3]
                feat_vect[band_dic[i_band]]['dim1pooling'][k]=pooling[1][i_band][i_state][k][:3]
