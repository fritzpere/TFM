    ...
    for i_band in range(-1,3):
        for i_state in range(3):
            for k in range(trials[i_state]):
                ...
                feat_vect[band_dic[i_band]]['Life,3vec0'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec0'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['Life,entropy0'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['entropy0'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['entropy,3vec0'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['entropy0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec0'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['Life,entropy,3vec0'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life,entropy0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec0'][cum_trials[i_state]+k]),axis=0)
                ...
                feat_vect[band_dic[i_band]]['Life,3vec1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['Life,entropy1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['entropy1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['entropy,3vec1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['entropy1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['Life,entropy,3vec1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life,entropy1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec1'][cum_trials[i_state]+k]),axis=0)
                ...
                feat_vect[band_dic[i_band]]['midlife,Life1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['midlife1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['Life1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['midlife,entropy1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['midlife1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['entropy1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['midlife,3vec1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['midlife1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['midlife,Life,3vec1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['midlife1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['Life,3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['midlife,Life,entropy1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['midlife1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['Life,entropy1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['midlife,entropy,3vec1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['midlife1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['entropy,3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['midlife,Life,entropy,3vec1'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['midlife,Life1'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['entropy,3vec1'][cum_trials[i_state]+k]),axis=0)

                feat_vect[band_dic[i_band]]['Life01'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['Life1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['entropy01'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['entropy0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['entropy1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['3vec01'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['3vec0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['Life,3vec01'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life,3vec0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['Life,3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['Life,entropy01'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life,entropy0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['Life,entropy1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['entropy,3vec01'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['entropy,3vec0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['entropy,3vec1'][cum_trials[i_state]+k]),axis=0)
                feat_vect[band_dic[i_band]]['Life,entropy,3vec01'][cum_trials[i_state]+k]=np.concatenate((feat_vect[band_dic[i_band]]['Life,entropy,3vec0'][cum_trials[i_state]+k],feat_vect[band_dic[i_band]]['Life,entropy,3vec1'][cum_trials[i_state]+k]),axis=0)
