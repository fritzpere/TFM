...
if __name__ == "__main__":    
    ...
    for subject in subjects:
        ...
        #print(time.time()-t)
        elec_space_pers=compute_persistence_from_EEG(elec_space,measure='distance',subj_dir=subj_dir,space='electrode_space',save=True) #pointcloud shape (432, 50)
        ...
        #print(time.time()-t)
        font_space_pers=compute_persistence_from_EEG(font_space,measure='distance',subj_dir=subj_dir,space='font_space',save=True)
        ...
        #print(time.time()-t)
        plot_persistence(elec_space_pers,subj_dir,intervals=1000,space='electrode_space',measure='distance',save=True)
        plot_persistence(font_space_pers,subj_dir,intervals=1000,space='font_space',measure='distance',save=True)
